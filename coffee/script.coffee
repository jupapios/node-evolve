...
mutation_selected = document.getElementById('btn-medium')
color_selected = document.getElementById('btn-color-white')
...
change_mutation = (element) ->
	mutation_selected.className = ''
	mutation_selected = element
	element.className = 'active'

change_color = (element) ->
	color_selected.className = ''
	color_selected = element
	element.className = 'active'

init = () ->
	change_mutation(mutation_selected)
	change_color(color_selected)	
...
window.onload = () ->
	...
	#  mutations events
	document.getElementById('btn-gauss').onclick = () ->
		change_mutation this
	...
	# initial dna
	# colors buttons
	document.getElementById('btn-color-white').onclick = () ->
		change_color this
	document.getElementById('btn-color-black').onclick = () ->
		change_color this
	document.getElementById('btn-color-blue').onclick = () ->
		change_color this

	# polygons
	document.getElementById('btn-poly-more').onclick = () ->
		console.log 'poly more'
	document.getElementById('btn-poly-less').onclick = () ->
		console.log 'poly less'

	# vertex
	document.getElementById('btn-vert-more').onclick = () ->
		console.log 'vert more'
	document.getElementById('btn-vert-less').onclick = () ->
		console.log 'vert less'
